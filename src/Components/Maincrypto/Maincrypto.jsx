...
//   }}
// >
//  <button onClick={(e) => handleClick(e, value.id, value.ath_change_percentage, value.price_change_percentage_24h, value.symbol,value.image,value.ath_change_percentage )} ><i  className={`fas fa-eye ${isClicked ? "text-green-500" : ""}`}></i> </button> {value.ath_change_percentage}
// </td>
